...
namespace AspNetCore.Activemq.Integration
{
    ...
    {
        public ActiveConsumer(bool isCluster, string[] hostAndPorts, string query = null, ActiveProtocol protocol = ActiveProtocol.OpenWrite) :
        ...
        private IConnection GetConnection(ListenOptions listenOptions)
        {
            ...
            InitListenConnection(connection, listenOptions);
            return connection;
        }
        /// <summary>
        /// 获取一个消费者
        ...
        {
            return new ActiveConsumer(activeBaseOptions.IsCluster, activeBaseOptions.BrokerUris, activeBaseOptions.Query, activeBaseOptions.Protocol)
            {
    ...
    public class ListenOptions
    {
        ...
        /// <summary>
        /// 每次发送消息条数（只在Protocol=OpenWrite协议上生效）
        /// </summary>
