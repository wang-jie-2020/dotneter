...
//        // This method is invoked when an asynchronous receive operation completes. If the remote
//        // host closed the connection, then the socket is closed. If data was received then the data
