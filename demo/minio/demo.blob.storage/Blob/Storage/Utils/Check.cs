...
namespace Demo.Blob.Storage.Utils
{
    [DebuggerStepThrough]
    public static class Check
    {
            ...
            [InvokerParameterName][NotNull] string parameterName)
        {
            ...
            {
                throw new ArgumentException($"{parameterName} (type of {type.AssemblyQualifiedName}) should be assignable to the {typeof(TBaseType).AssemblyQualifiedName}!");
            }
