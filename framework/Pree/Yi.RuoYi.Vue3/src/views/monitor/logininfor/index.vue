<template>
  <div class="app-container">
    ...
    <el-table ref="logininforRef" v-loading="loading" :data="logininforList" @selection-change="handleSelectionChange"
      ...
      <el-table-column label="用户名称" align="center" prop="loginUser" :show-overflow-tooltip="true" sortable="custom"
      ...
      <el-table-column label="访问时间" align="center" prop="creationTime" sortable="custom"
