...
namespace Demo.Blob.Storage.Minio
{
    public class MinioBlobProviderConfiguration
    {
        ...
        {
            get => _containerConfiguration.GetConfigurationOrDefault<string>(MinioBlobProviderConfigurationNames.EndPoint);
        ...
        {
            get => _containerConfiguration.GetConfigurationOrDefault<string>(MinioBlobProviderConfigurationNames.AccessKey);
        ...
        {
            get => _containerConfiguration.GetConfigurationOrDefault<string>(MinioBlobProviderConfigurationNames.SecretKey);
