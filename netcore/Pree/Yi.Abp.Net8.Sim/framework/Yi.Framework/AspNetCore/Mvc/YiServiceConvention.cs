...
{
    public YiServiceConvention(IOptions<AbpAspNetCoreMvcOptions> options,
        ...
        ConventionalControllerSetting? configuration)
    {
        ...
        if (remoteServiceAtt != null && !remoteServiceAtt.IsEnabledFor(action.ActionMethod)) return;
    ...
    protected override void AddAbpServiceSelector(string rootPath, string controllerName, ActionModel action,
        ConventionalControllerSetting? configuration)
    {
        ...
        ConventionalControllerSetting? configuration)
    {
        foreach (var selector in action.Selectors)
        {
            ...
            if (httpMethod == null) httpMethod = SelectHttpMethod(action, configuration);
