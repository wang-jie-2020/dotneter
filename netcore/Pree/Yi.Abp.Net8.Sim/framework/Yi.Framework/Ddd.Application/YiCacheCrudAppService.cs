...
public abstract class
    YiCacheCrudAppService<TEntity, TEntityDto, TKey> : YiCrudAppService<TEntity, TEntityDto, TKey,
    ...
    where TGetListOutputDto : IEntityDto<TKey>
{
    ...
    public override async Task DeleteAsync(IEnumerable<TKey> id)
    {
        ...
        foreach (var itemId in id) await Cache.RemoveAsync(GetCacheKey(itemId));
    }
}