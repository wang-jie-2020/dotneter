...
using IResourceNamesCache = I18n.LocalizationExtensions.Caching.IResourceNamesCache;
using ResourceNamesCache = I18n.LocalizationExtensions.Caching.ResourceNamesCache;
...
public class JsonStringLocalizerFactory : IStringLocalizerFactory
{
    ...
    private static string TrimPrefix(string name, string prefix)
    {
        ...
        {
            return name.Substring(prefix.Length, name.Length - prefix.Length);//name[prefix.Length..];
        }
