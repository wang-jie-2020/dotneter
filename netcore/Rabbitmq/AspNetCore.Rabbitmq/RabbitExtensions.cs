...
using AspNetCore.Rabbitmq.Producers;
...
namespace AspNetCore.Rabbitmq
{
    public static class RabbitExtensions
    {
        ...
        public static void Publish(this IRabbitClientProducer producer, string message, MessageOptions options = null)
        {
            producer.Publish(new string[] { message }, options);
        }
        /// <summary>
        /// 使用交换机发送消息
        /// </summary>
        ...
        /// <param name="message"></param>
        /// <param name="options"></param>
        public static void Publish(this IRabbitClientProducer producer, string routingKey, string message, MessageOptions options = null)
        {
            producer.Publish(routingKey, new string[] { message }, options);
        }
        /// <summary>
        /// 普通的往队列发送消息
        /// </summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static async Task PublishAsync(this IRabbitClientProducer producer, string message, MessageOptions options = null)
        {
            await producer.PublishAsync(new string[] { message }, options);
        }
        /// <summary>
        /// 使用交换机发送消息
        /// </summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static async Task PublishAsync(this IRabbitClientProducer producer, string routingKey, string message, MessageOptions options = null)
        {
            await producer.PublishAsync(routingKey, new string[] { message }, options);
        }
        /// <summary>
        /// 普通的往队列发送消息
        /// </summary>
        ...
        /// <param name="messages"></param>
        /// <param name="options"></param>
        public static async Task PublishAsync(this IRabbitClientProducer producer, string[] messages, MessageOptions options = null)
        {
            await Task.Run(() =>
            {
                producer.Publish(messages, options);
            });
        }
        /// <summary>
        /// 使用交换机发送消息
        ...
        /// <param name="messages"></param>
        /// <param name="options"></param>
        public static async Task PublishAsync(this IRabbitClientProducer producer, string routingKey, string[] messages, MessageOptions options = null)
        {
            await Task.Run(() =>
            {
                producer.Publish(routingKey, messages, options);
            });
        }
